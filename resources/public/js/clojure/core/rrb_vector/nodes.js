...
var slc = (rngs[(32)]);
if((slc === (32))){
var or__4160__auto__ = (shift === (5));
if(or__4160__auto__){
return or__4160__auto__;
} else {
var G__25376 = (root.arr[(slc - (1))]);
var G__25377 = (shift - (5));
var G__25378 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__25376;
shift = G__25377;
cnt = G__25378;
continue;
...
if((!(r_QMARK_))){
var rngs_25387 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_25388 = (rngs_25387[(0)]);
var new_rngs_25389 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_25390 = (rngs_25387[(32)]);
cljs.core.array_copy.call(null,rngs_25387,(1),new_rngs_25389,(0),(lim_25390 - (1)));

var i_25391 = (0);
while(true){
if((i_25391 < lim_25390)){
(new_rngs_25389[i_25391] = ((new_rngs_25389[i_25391]) - rng0_25388));
...
(new_rngs_25389[(32)] = ((rngs_25387[(32)]) - (1)));

(new_rngs_25389[((rngs_25387[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_25389);
} else {
}
...
while(true){
if((i_25393 <= li)){
(new_rngs[i_25393] = ((new_rngs[(i_25393 - (1))]) + step));
...
while(true){
if((i_25395 <= li)){
(new_rngs[i_25395] = ((rngs[i_25395]) - d));

var G__25396 = (i_25395 + (1));
i_25395 = G__25396;
continue;
} else {
}
...
while(true){
if((j_25397 <= i)){
(rngs[j_25397] = r_25398);

var G__25399 = (j_25397 + (1));
var G__25400 = (r_25398 + step);
j_25397 = G__25399;
r_25398 = G__25400;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__25401 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__25401[(0)] = node.arr.length);
...
var arr_25402__$1 = arr;
var shift_25403__$1 = shift;
while(true){
if((shift_25403__$1 === (5))){
if((!(reg_QMARK_))){
(arr_25402__$1[(32)] = rngs);
} else {
}

(arr_25402__$1[(0)] = node);
} else {
var a_25404 = (new Array(len));
var e_25405 = cljs.core.__GT_VectorNode.call(null,null,a_25404);
(arr_25402__$1[(0)] = e_25405);
...
var G__25406 = a_25404;
var G__25407 = (shift_25403__$1 - (5));
arr_25402__$1 = G__25406;
shift_25403__$1 = G__25407;
continue;
}
break;
}
