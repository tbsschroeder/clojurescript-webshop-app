(defproject cljs-webshop "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cljs-webshop.core/on-js-reload"
                ...
                :compiler {:main cljs-webshop.core
                           :target :bundle
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/clojurescript.js"
